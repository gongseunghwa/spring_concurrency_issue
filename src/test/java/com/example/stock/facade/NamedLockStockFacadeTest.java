...
class NamedLockStockFacadeTest {
    ...
    @Autowired
    NamedLockStockService namedLockStockService;
    ...
    @Test
    public void 동시에_100개의_요청_성공() throws InterruptedException {
        int threadCount = 100;
    ...
    @Test
    public void 동시에_100개의_요청_실패() throws InterruptedException {
        int threadCount = 100;
        ExecutorService executorService = Executors.newFixedThreadPool(32);
        CountDownLatch latch = new CountDownLatch(threadCount);
        for(int i=0; i<threadCount; i++){
